...
ResumeSelector::ResumeSelector() : selected(0), nButtons(2){
    Button* buttonResumeGame = new Button(Vec2(500, 250),"resources/img/MenuButton.png", "Resume",24);
    Button* buttonSaveGame = new Button(Vec2(500, 400),"resources/img/MenuButton.png", "Save Game", 24);
    Button* buttonExitsGame = new Button(Vec2(500, 550),"resources/img/MenuButton.png", "Exit", 24);
